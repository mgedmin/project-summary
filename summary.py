...
def get_repos(config):
    with open(os.path.join(here, config.repos)) as f:
...
class Project(object):
    ...
    def jenkins_image_url(self):
        ...
        return '{base}/job/{name}/badge/icon'.format(
            base=self.config.jenkins_url, name=self.jenkins_job)
    ...
    def jenkins_image_url_windows(self):
        ...
        return '{base}/job/{name}/badge/icon'.format(
            base=self.config.jenkins_url, name=job)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Summarize release status of projects in %s" % config.repos)
...
def print_html_report(projects, config, filename=None):
    ...
    html = template.render_unicode(projects=list(projects),
                                   ...
                                   jenkins_windows=config.jenkins_windows,
